...
class admin_fs_venezuela extends fs_controller {
    ...
    private function check_accounting_year() {
        ...
        foreach ($ejer->all_abiertos() as $accountingYear) {
            if ($accountingYear->longsubcuenta != 6) {
                ...
                $accountingYear->save() ?
                        $this->new_message('Datos del ejercicio ' . $accountingYear->codejercicio . ' modificados correctamente.') 
    ...
    public function is_set_accounting_year() {
        ...
        if ($accountingYear) {
            ...
            foreach ($subAccountingYear0->all_from_ejercicio($accountingYear->codejercicio) as $sc) {
                return true;
            }
        }
        return false;
